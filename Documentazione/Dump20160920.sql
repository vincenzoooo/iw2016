...
CREATE TABLE `autore_has_pubblicazione` (
  ...
  KEY `fk_autore_has_pubblicazione_pubblicazione_idx` (`pubblicazione_idpubblicazione`),
  ...
  CONSTRAINT `fk_autore_has_pubblicazione_pubblicazione` FOREIGN KEY (`pubblicazione_idpubblicazione`) REFERENCES `pubblicazione` (`idpubblicazione`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `capitolo` (
  ...
  `pubblicazione` int(11) DEFAULT NULL,
  PRIMARY KEY (`idcapitolo`),
  KEY `fk_capitolo_pubblicazione_idx` (`pubblicazione`),
  CONSTRAINT `fk_capitolo_pubblicazione` FOREIGN KEY (`pubblicazione`) REFERENCES `pubblicazione` (`idpubblicazione`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `consigli_utente`
--

DROP TABLE IF EXISTS `consigli_utente`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `consigli_utente` (
  `pubblicazione_idpubblicazione` int(11) NOT NULL,
  `utente_idutente` int(11) NOT NULL,
  PRIMARY KEY (`pubblicazione_idpubblicazione`,`utente_idutente`),
  KEY `fk_consigli_utente_utente_idx` (`utente_idutente`),
  CONSTRAINT `fk_consigli_utente_pubblicazione` FOREIGN KEY (`pubblicazione_idpubblicazione`) REFERENCES `pubblicazione` (`idpubblicazione`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `fk_consigli_utente_utente` FOREIGN KEY (`utente_idutente`) REFERENCES `utente` (`idutente`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pubblicazione_has_keyword` (
  ...
  CONSTRAINT `fk_pubblicazione_has_keyword_pubblicazione` FOREIGN KEY (`pubblicazione_idpubblicazione`) REFERENCES `pubblicazione` (`idpubblicazione`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `recensione` (
  ...
  CONSTRAINT `fk_recensione_pubblicazione` FOREIGN KEY (`pubblicazione`) REFERENCES `pubblicazione` (`idpubblicazione`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
CREATE TABLE `ristampa` (
  ...
  CONSTRAINT `fk_ristampe_pubblicazione` FOREIGN KEY (`pubblicazione`) REFERENCES `pubblicazione` (`idpubblicazione`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `sezione` (
  ...
  `numero` int(11) DEFAULT NULL,
  `titolo` varchar(100) DEFAULT NULL,
  `capitolo` int(11) DEFAULT NULL,
  PRIMARY KEY (`idsezione`),
  KEY `fk_sezione_capitolo_idx` (`capitolo`),
  CONSTRAINT `fk_sezione_capitolo` FOREIGN KEY (`capitolo`) REFERENCES `capitolo` (`idcapitolo`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `sorgente` (
  ...
  KEY `fk_sorgente_pubblicazione_idx` (`pubblicazione`),
  CONSTRAINT `fk_sorgente_pubblicazione` FOREIGN KEY (`pubblicazione`) REFERENCES `pubblicazione` (`idpubblicazione`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `storico` (
  ...
  CONSTRAINT `fk_storico_pubblicazione` FOREIGN KEY (`pubblicazione`) REFERENCES `pubblicazione` (`idpubblicazione`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
-- Dump completed on 2016-09-20 20:42:32
